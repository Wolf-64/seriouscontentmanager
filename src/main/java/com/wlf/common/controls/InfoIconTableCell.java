...
public class InfoIconTableCell<S, T extends InfoIconProperty> extends TableCell<S, T> {
    private static final String ERROR_CONVERTER_NULL = "Argument 'converter' must not be null";

    public static <S, T extends InfoIconProperty> Callback<TableColumn<S, T>, TableCell<S, T>> forTableColumn() {
        return param -> new InfoIconTableCell<S, T>();
    }

    public static <S, T extends InfoIconProperty> Callback<TableColumn<S, T>, TableCell<S, T>> forTableColumn(StringConverter<T> converter) {
        return param -> new InfoIconTableCell<S, T>(converter);
    }
    ...
    public InfoIconTableCell(StringConverter<T> converter) {
